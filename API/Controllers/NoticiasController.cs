...
namespace API.Controllers
{
    ...
    public class NewsController : ControllerBase
    {
        ...
        [HttpGet("{page}/{qtd}")]
        public ActionResult<Result<News>> Get(int page, int qtd)
        {
            _logger.LogInformation($"Buscando através da pagina {page}");

            return _newsService.Get(page, qtd);
        }
        ...
        public ActionResult<News> Get(string id)
        {
            ...
            _logger.LogInformation($"Buscando através do ID {id}");
